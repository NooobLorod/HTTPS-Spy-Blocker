...
game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Http Spy"}
...
_G.BlockedDomains  = _G.BlockedDomains or {
    ...
    "roblox.com/Thumbs/Avatar.ashx?x=150&y=150&Format=Png&username=";
...
---------------------------------------------
    ...
    rprint("Made for Personal Use: NooobLorod Not for business or use for other people besides NooobLorod")
end
